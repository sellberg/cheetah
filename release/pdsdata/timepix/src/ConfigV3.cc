...
void ConfigV3::chip0Name(const char *name)
{
...
void ConfigV3::chip1Name(const char *name)
{
...
void ConfigV3::chip2Name(const char *name)
{
...
void ConfigV3::chip3Name(const char *name)
{
  strncpy(_chip3Name, name, ChipNameMax);
}

void ConfigV3::driverVersion(int32_t version)
{
...
void ConfigV3::firmwareVersion(uint32_t version)
{
...
void ConfigV3::pixelThresh(uint32_t threshSize, uint8_t *thresh)
{
...
const uint8_t * ConfigV3::pixelThresh() const
{
  return (_pixelThresh);
}

void ConfigV3::dump() const {
