// $Id: ConfigV3.hh,v 1.1 2012/12/20 17:50:13 caf Exp $
// Author: Chris Ford <caf@slac.stanford.edu>

//
//  Class for configuration of Timepix
//
#ifndef TIMEPIXCONFIGV3_HH
#define TIMEPIXCONFIGV3_HH
...
namespace Pds {
  ...
  namespace Timepix {
    ...
    public:
      ...
      enum TimepixMode  { TimepixMode_Counting=0, TimepixMode_TOT };
      enum { ChipCount=4 };
      enum { ChipNameMax=15 };
      ...
      ConfigV3(uint8_t readoutSpeed, uint8_t timepixMode, int32_t timepixSpeed,
               ...
               int32_t dac3BiasLvds, int32_t dac3RefLvds, uint8_t dacBias, uint8_t flags);

      unsigned          size()              const     { return (unsigned) sizeof(*this); }

      uint8_t           readoutSpeed()      const     { return _readoutSpeed; }
      uint8_t           timepixMode()       const     { return _timepixMode; }
      ...
      uint8_t           dacBias()          const     { return _dacBias; }
